...
- [ ] **[P0]** Implement trajectory validation logic [CAREER-005]
  ...
  - Check salary bounds (0-200 LPA)
  - Verify monotonicity (no >20% drops)
  - Validate skill gaps are non-empty for low salaries
- [ ] **[P0]** Implement scenario comparison [CAREER-006] [REQ-SIM-021]
  ...
  - Calculate salary impact of actions [REQ-SIM-022]
...
- [ ] **[P0]** Implement impact feedback generator [RESUME-INT-005] [REQ-RES-018]
  ...
  - Explain salary impact of resume weaknesses [REQ-RES-018]
  - Quantify improvement potential in LPA [REQ-RES-019]
...
- [ ] **[P0]** Career simulation generates 3 scenarios with salary projections [REQ-SIM-006, REQ-SIM-007]
- [ ] **[P0]** Resume analysis completes within 5 seconds [REQ-RES-002]
- [ ] **[P0]** Property-based test: Salary trajectory monotonicity (design.md Section 5.1)
...
- [ ] **[P0]** Create career trajectory visualization [DASHBOARD-002] [REQ-SIM-006]
  ...
  - Create line chart for salary progression over 5 years
...
- [ ] **[P0]** Create scenario comparison view [DASHBOARD-003] [REQ-SIM-021]
  ...
  - Show salary impact of actions [REQ-SIM-022]
...
- [ ] **[P0]** Create impact feedback section [RESUME-DASH-005] [REQ-RES-018]
  - Explain current trajectory (e.g., "6 LPA path")
  - List improvements with salary impact [REQ-RES-019]
  - Show ROI-prioritized actions [REQ-RES-021]
  - Display total potential gain in LPA
...
- [ ] **[P0]** Write property-based tests [TEST-002]
  - Salary trajectory monotonicity (design.md Section 5.1)
...
- [ ] Property 1: Salary trajectory monotonicity validated
