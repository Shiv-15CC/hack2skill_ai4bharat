...
- **Data/Numbers:** JetBrains Mono (for percentages, metrics, probabilities)

### Localization
- **Metrics:** Display in percentages and probability scores
...
block-beta
  ...
  block:main:10
    ...
    block:trajectory:10
      ...
      space:10
      SalaryChart["Career Success Progression Chart (%)"]
      space:10
    end
...
| **Success Chart** | Line chart showing 5-year career success progression | Hover to see exact values, confidence intervals | Shaded area for confidence intervals | REQ-SIM-007, REQ-SIM-010 |
...
│  ├──────────────────────┤    ├──────────────────────┤      │
│  │                      │    │                      │      │
│  │  Year 5 Success      │    │  Year 5 Success      │      │
│  │  85% Placement       │    │  50% Placement       │      │
│  │                      │    │                      │      │
...
│  └──────────────────────┘    └──────────────────────┘      │
│                                                               │
│  💡 Impact: +35% placement success by doing 2 internships   │
│                                                               │
└─────────────────────────────────────────────────────────────┘
```
...
| **Success Difference** | Highlight career impact | Animated number counter | Large, bold text with % symbol | REQ-SIM-022 |
...
│  │     ████████████████████░░  Est. Time: 120 hrs      │    │
│  │     Career Impact: +25% interview success            │    │
│  │     [Start Learning]                                 │    │
│  │                                                       │    │
│  │  2. Data Structures & Algorithms     Impact: 92/100  │    │
│  │     ████████████████████░░  Est. Time: 150 hrs      │    │
│  │     Career Impact: +30% placement rate               │    │
│  │     [Start Learning]                                 │    │
│  │                                                       │    │
│  └───────────────────────────────────────────────────────┘    │
│                                                               │
...
│  │     █████████░░░░░░░░░░  Est. Time: 40 hrs          │    │
│  │     Career Impact: +8% interview callbacks           │    │
│  │     [Start Learning]                                 │    │
│  │                                                       │    │
│  └───────────────────────────────────────────────────────┘    │
│                                                               │
│  Total Learning Time: 390 hours (~20 weeks at 20 hrs/week)  │
│  Total Career Potential: +78% placement success             │
│                                                               │
└─────────────────────────────────────────────────────────────┘
```
...
| **Career Impact Label** | Potential career improvement | Calculated from market data | Bold text with % symbol | REQ-SIM-012 |
...
├─────────────────────────────────────────────────────────────┤
│                                                               │
│  Current Trajectory: 45% Placement Success Path             │
│  Potential Trajectory: 80% Placement Success Path (+35%)    │
│                                                               │
│  ┌─────────────────────────────────────────────────────┐    │
│  │  Why You're on the 45% Success Path                 │    │
│  ├─────────────────────────────────────────────────────┤    │
│  │                                                       │    │
...
│  │     Career Impact: -10% interview callbacks          │    │
│  │                                                       │    │
│  └───────────────────────────────────────────────────────┘    │
│                                                               │
│  ┌─────────────────────────────────────────────────────┐    │
│  │  How to Reach 80% Success Path                      │    │
│  ├─────────────────────────────────────────────────────┤    │
│  │                                                       │    │
│  │  ✅ Add system design project                        │    │
│  │     Effort: 2 weeks | Impact: +25% interviews | ROI: ⭐⭐⭐│    │
│  │     [Start Project]                                  │    │
│  │                                                       │    │
│  │  ✅ Get AWS certification                            │    │
│  │     Effort: 3 weeks | Impact: +15% offers | ROI: ⭐⭐⭐   │    │
│  │     [View Courses]                                   │    │
│  │                                                       │    │
│  │  ✅ Quantify all achievements                        │    │
│  │     Effort: 1 day | Impact: +10% callbacks | ROI: ⭐⭐⭐⭐⭐│    │
│  │     [Fix Now]                                        │    │
│  │                                                       │    │
│  └───────────────────────────────────────────────────────┘    │
│                                                               │
...
| **Impact Amount** | Display career improvement | Bold, large text | Percentage with + symbol | REQ-RES-019 |
